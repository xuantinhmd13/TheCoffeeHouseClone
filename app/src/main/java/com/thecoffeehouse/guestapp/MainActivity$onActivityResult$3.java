...
final class MainActivity$onActivityResult$3 extends Lambda implements Function2<AddressSuggestion, Boolean, Unit> {
    final /* synthetic */ MainActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainActivity$onActivityResult$3(MainActivity mainActivity) {
        super(2);
    ...
    public final void invoke(AddressSuggestion addressSuggestion, Boolean bool) {
        ...
        this.this$0.getMOrderFragment().onChangeShippingMethod(this.this$0.getMOrderFragment().getCurrentMethod(), addressSuggestion, this.this$0.getMOrderFragment().currentPickUpInfo(), this.this$0.getMOrderFragment().currentTableInfo());
    }
}
