...
final class MainActivity$onActivityResult$2 extends Lambda implements Function1<AddressSuggestion, Unit> {
    final /* synthetic */ MainActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainActivity$onActivityResult$2(MainActivity mainActivity) {
        super(1);
    ...
    public final void invoke(AddressSuggestion addressSuggestion) {
        ...
        bottomNavigationView.setSelectedItemId(this.this$0.mCurrentBottomNavigationItemId);
    }
}
