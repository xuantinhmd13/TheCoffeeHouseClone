...
public final class StoresFragment$addStoreItemRow$itemRowPickStore$2 extends Lambda implements Function1<Store, Unit> {
    final /* synthetic */ StoresFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StoresFragment$addStoreItemRow$itemRowPickStore$2(StoresFragment storesFragment) {
        super(1);
