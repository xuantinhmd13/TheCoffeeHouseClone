...
final class WebViewDialogFragment$initViews$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ WebViewDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    WebViewDialogFragment$initViews$2(WebViewDialogFragment webViewDialogFragment) {
        super(1);
