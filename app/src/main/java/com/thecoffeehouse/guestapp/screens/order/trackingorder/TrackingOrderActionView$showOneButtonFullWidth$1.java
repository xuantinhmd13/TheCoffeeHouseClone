...
final class TrackingOrderActionView$showOneButtonFullWidth$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ OrderButtonStatus $button;
    final /* synthetic */ TrackingOrderActionView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TrackingOrderActionView$showOneButtonFullWidth$1(TrackingOrderActionView trackingOrderActionView, OrderButtonStatus orderButtonStatus) {
        super(1);
