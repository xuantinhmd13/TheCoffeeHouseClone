...
public final class MapViewInteraction$getClosetStoreFromUserLocation$$inlined$sortedBy$1<T> implements Comparator<T> {
    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        Double distance = t.getDistance();
        double d = Double.MAX_VALUE;
        Double valueOf = Double.valueOf(distance != null ? distance.doubleValue() : Double.MAX_VALUE);
        Double distance2 = t2.getDistance();
        if (distance2 != null) {
