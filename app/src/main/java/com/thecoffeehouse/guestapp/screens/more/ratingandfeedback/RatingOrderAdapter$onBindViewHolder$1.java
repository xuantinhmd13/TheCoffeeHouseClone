...
public final class RatingOrderAdapter$onBindViewHolder$1 implements View.OnClickListener {
    final /* synthetic */ OrderHistory $order;
    final /* synthetic */ int $position;
    final /* synthetic */ RatingOrderAdapter this$0;

    RatingOrderAdapter$onBindViewHolder$1(RatingOrderAdapter ratingOrderAdapter, OrderHistory orderHistory, int i) {
    ...
    public final void onClick(View view) {
        this.this$0.onClickListener.invoke(this.$order, Integer.valueOf(this.$position));
    }
}
