...
public final class NewsAndPromotionsDialogFragment$openShareReportPopup$1 extends Lambda implements Function1<View, Unit> {
    ...
    NewsAndPromotionsDialogFragment$openShareReportPopup$1(NewsAndPromotionsDialogFragment newsAndPromotionsDialogFragment, String str, BottomSheetDialog bottomSheetDialog) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        this.this$0.openShareIntent(this.$shareUrl);
