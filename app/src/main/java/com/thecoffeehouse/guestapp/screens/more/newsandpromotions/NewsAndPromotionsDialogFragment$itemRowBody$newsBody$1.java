...
public final class NewsAndPromotionsDialogFragment$itemRowBody$newsBody$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ String $name;
    final /* synthetic */ PostsItem $post;
    final /* synthetic */ NewsAndPromotionsDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NewsAndPromotionsDialogFragment$itemRowBody$newsBody$1(NewsAndPromotionsDialogFragment newsAndPromotionsDialogFragment, PostsItem postsItem, String str) {
        super(0);
