...
final class MenuDetailDialogFragment$onChangeShippingMethod$1 extends Lambda implements Function3<Integer, AddressOrder, Store, Unit> {
    public static final MenuDetailDialogFragment$onChangeShippingMethod$1 INSTANCE = new MenuDetailDialogFragment$onChangeShippingMethod$1();

    MenuDetailDialogFragment$onChangeShippingMethod$1() {
        super(3);
    }
