...
final class ConfirmationOTPDialog$enterCodeEditTextFocusListener$1 implements View.OnFocusChangeListener {
    final /* synthetic */ ConfirmationOTPDialog this$0;

    ConfirmationOTPDialog$enterCodeEditTextFocusListener$1(ConfirmationOTPDialog confirmationOTPDialog) {
        this.this$0 = confirmationOTPDialog;
    }

    public final void onFocusChange(View view, boolean z) {
        if (z) {
            ((EditText) this.this$0.findViewById(R.id.edt_enter_code_2)).setText("");
            ((EditText) this.this$0.findViewById(R.id.edt_enter_code_3)).setText("");
