...
final class RatingAndFeedbackFragment$runInAppRatingFlow$1<ResultT> implements OnCompleteListener<ReviewInfo> {
    final /* synthetic */ ReviewManager $manager;
    final /* synthetic */ RatingAndFeedbackFragment this$0;

    RatingAndFeedbackFragment$runInAppRatingFlow$1(RatingAndFeedbackFragment ratingAndFeedbackFragment, ReviewManager reviewManager) {
        ...
        if (this.this$0.getActivity() != null) {
            ...
            if (task.isSuccessful()) {
                this.$manager.launchReviewFlow(this.this$0.getActivity(), task.getResult()).addOnCompleteListener(new OnCompleteListener<Void>(this) {
                    /* class com.thecoffeehouse.guestapp.screens.more.ratingandfeedback.RatingAndFeedbackFragment$runInAppRatingFlow$1.AnonymousClass1 */
                    final /* synthetic */ RatingAndFeedbackFragment$runInAppRatingFlow$1 this$0;
