...
/* compiled from: di.kt */
public final class BaseViewModel$$special$$inlined$inject$2 implements ReadOnlyProperty<Object, TCHApplication> {
    final /* synthetic */ String $scope;
    private TCHApplication value;

    public BaseViewModel$$special$$inlined$inject$2(String str) {
        this.$scope = str;
    }
