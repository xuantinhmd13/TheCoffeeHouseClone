...
final class RewardsFragment$initBigRewardGroup$itemRowReward$1 extends Lambda implements Function1<Reward, Unit> {
    final /* synthetic */ RewardsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RewardsFragment$initBigRewardGroup$itemRowReward$1(RewardsFragment rewardsFragment) {
        super(1);
