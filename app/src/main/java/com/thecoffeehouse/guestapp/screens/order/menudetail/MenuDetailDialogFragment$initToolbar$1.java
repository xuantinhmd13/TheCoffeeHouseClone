...
final class MenuDetailDialogFragment$initToolbar$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ MenuDetailDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MenuDetailDialogFragment$initToolbar$1(MenuDetailDialogFragment menuDetailDialogFragment) {
        super(1);
