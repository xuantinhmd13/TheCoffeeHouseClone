...
public final class MapViewInteraction$mapViewListeners$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ MapViewInteraction this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MapViewInteraction$mapViewListeners$2(MapViewInteraction mapViewInteraction) {
        super(1);
