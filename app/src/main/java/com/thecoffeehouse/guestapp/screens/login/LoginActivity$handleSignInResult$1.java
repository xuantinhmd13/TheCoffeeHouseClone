...
public final class LoginActivity$handleSignInResult$1 extends Lambda implements Function1<AuthResponse, Unit> {
    final /* synthetic */ LoginActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LoginActivity$handleSignInResult$1(LoginActivity loginActivity) {
        super(1);
    ...
    public final void invoke(AuthResponse authResponse) {
        ...
        this.this$0.mLoginWithPhone = false;
