...
public final class LoginActivity$callSignUpOTPToServer$2 extends Lambda implements Function1<ServerErrorResponse, Unit> {
    final /* synthetic */ LoginActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LoginActivity$callSignUpOTPToServer$2(LoginActivity loginActivity) {
        super(1);
