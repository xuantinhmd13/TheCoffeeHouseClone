...
public final class HelpDialogFragment$initViews$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ HelpDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HelpDialogFragment$initViews$2(HelpDialogFragment helpDialogFragment) {
        super(1);
