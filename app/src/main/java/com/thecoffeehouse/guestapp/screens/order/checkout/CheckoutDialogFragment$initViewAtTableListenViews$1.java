...
public final class CheckoutDialogFragment$initViewAtTableListenViews$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ CheckoutDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CheckoutDialogFragment$initViewAtTableListenViews$1(CheckoutDialogFragment checkoutDialogFragment) {
        super(0);
