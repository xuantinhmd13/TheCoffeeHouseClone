...
public final class ConfirmationOTPDialog$enterCodeEditTextListener$3 implements View.OnKeyListener {
    final /* synthetic */ ConfirmationOTPDialog this$0;

    ConfirmationOTPDialog$enterCodeEditTextListener$3(ConfirmationOTPDialog confirmationOTPDialog) {
    ...
    public final boolean onKey(View view, int i, KeyEvent keyEvent) {
        ...
        ((EditText) this.this$0.findViewById(R.id.edt_enter_code_1)).requestFocus();
        return false;
    }
}
