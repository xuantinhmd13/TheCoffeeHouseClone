...
public final class CouponDetailDialogFragmentV3$viewModel$2 extends Lambda implements Function0<OrderViewModel> {
    final /* synthetic */ CouponDetailDialogFragmentV3 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CouponDetailDialogFragmentV3$viewModel$2(CouponDetailDialogFragmentV3 couponDetailDialogFragmentV3) {
        super(0);
