...
final class AccumulatePointsFragment$addItemRowOtherReward$rowItemRowFeatureRewards$1 extends Lambda implements Function1<Reward, Unit> {
    final /* synthetic */ Reward $reward;
    final /* synthetic */ AccumulatePointsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AccumulatePointsFragment$addItemRowOtherReward$rowItemRowFeatureRewards$1(AccumulatePointsFragment accumulatePointsFragment, Reward reward) {
        super(1);
    ...
    public final void invoke(Reward reward) {
        ...
        AccumulatePointsFragment.access$showRewardDetailDialogFragment(this.this$0, this.$reward);
    }
}
