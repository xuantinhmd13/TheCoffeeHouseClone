...
public final class RewardDetailDialogFragment$mRewardViewModel$2 extends Lambda implements Function0<RewardsViewModel> {
    final /* synthetic */ RewardDetailDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RewardDetailDialogFragment$mRewardViewModel$2(RewardDetailDialogFragment rewardDetailDialogFragment) {
        super(0);
