...
final class SignUpDialogFragment$openBottomSheetAvatar$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ BottomSheetDialog $shareReportBottomSheetDialog;
    final /* synthetic */ SignUpDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SignUpDialogFragment$openBottomSheetAvatar$2(SignUpDialogFragment signUpDialogFragment, BottomSheetDialog bottomSheetDialog) {
        super(1);
