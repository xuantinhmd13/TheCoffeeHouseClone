...
import com.thecoffeehouse.guestapp.screens.rewards.beanhistory.BeanHistoryDialogFragment;
...
final class AccumulatePointsFragment$initButtonCards$3 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ AccumulatePointsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AccumulatePointsFragment$initButtonCards$3(AccumulatePointsFragment accumulatePointsFragment) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        BeanHistoryDialogFragment beanHistoryDialogFragment = new BeanHistoryDialogFragment();
        ...
        if (access$getMainActivity != null) {
            ...
            beanHistoryDialogFragment.show(supportFragmentManager, (String) null);
        }
    }
}
