...
final class MenuDetailDialogFragment$Companion$newInstance$1 extends Lambda implements Function1<Product, Unit> {
    public static final MenuDetailDialogFragment$Companion$newInstance$1 INSTANCE = new MenuDetailDialogFragment$Companion$newInstance$1();

    MenuDetailDialogFragment$Companion$newInstance$1() {
        super(1);
    }
