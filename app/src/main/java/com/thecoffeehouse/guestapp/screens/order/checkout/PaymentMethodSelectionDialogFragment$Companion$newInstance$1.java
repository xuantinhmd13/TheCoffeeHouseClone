...
final class PaymentMethodSelectionDialogFragment$Companion$newInstance$1 extends Lambda implements Function1<Payment, Unit> {
    public static final PaymentMethodSelectionDialogFragment$Companion$newInstance$1 INSTANCE = new PaymentMethodSelectionDialogFragment$Companion$newInstance$1();

    PaymentMethodSelectionDialogFragment$Companion$newInstance$1() {
        super(1);
    }
