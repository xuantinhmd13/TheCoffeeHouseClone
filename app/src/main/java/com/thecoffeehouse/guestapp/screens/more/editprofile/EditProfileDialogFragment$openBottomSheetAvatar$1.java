...
public final class EditProfileDialogFragment$openBottomSheetAvatar$1 extends Lambda implements Function1<View, Unit> {
    ...
    EditProfileDialogFragment$openBottomSheetAvatar$1(EditProfileDialogFragment editProfileDialogFragment, BottomSheetDialog bottomSheetDialog) {
        super(1);
