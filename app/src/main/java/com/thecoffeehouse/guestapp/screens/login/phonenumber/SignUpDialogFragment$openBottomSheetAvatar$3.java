...
final class SignUpDialogFragment$openBottomSheetAvatar$3 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ BottomSheetDialog $shareReportBottomSheetDialog;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SignUpDialogFragment$openBottomSheetAvatar$3(BottomSheetDialog bottomSheetDialog) {
        super(1);
