...
public final class ItemRowMediumRewards$onResolve$$inlined$doOnLayout$2 implements View.OnLayoutChangeListener {
    final /* synthetic */ ItemRowMediumRewards this$0;

    public ItemRowMediumRewards$onResolve$$inlined$doOnLayout$2(ItemRowMediumRewards itemRowMediumRewards) {
    ...
    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        Glide.with(this.this$0.getImgLogo().getContext()).load(ItemRowMediumRewards.access$getReward$p(this.this$0).getLogo()).into(this.this$0.getImgLogo());
    }
}
