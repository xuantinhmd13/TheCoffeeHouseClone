...
final class MapPickLocationFragment$onSelectAddressSuggestion$1 extends Lambda implements Function1<AddressSuggestion, Unit> {
    public static final MapPickLocationFragment$onSelectAddressSuggestion$1 INSTANCE = new MapPickLocationFragment$onSelectAddressSuggestion$1();

    MapPickLocationFragment$onSelectAddressSuggestion$1() {
        super(1);
    }
