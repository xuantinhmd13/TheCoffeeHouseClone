...
public final class SavedAddressesFragment$addRowItemSavedAddress$1 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ SavedAddressesFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SavedAddressesFragment$addRowItemSavedAddress$1(SavedAddressesFragment savedAddressesFragment) {
        super(1);
    ...
    public final void invoke(int i) {
        ...
        addressSuggestion.setTitle(this.this$0.getString(R.string.str_home));
        addressSuggestion.setType(AddressType.INSTANCE.getHOME());
