...
public final class StoresFragment$addStoreItemRow$itemRowPickStore$1 extends Lambda implements Function1<Store, Unit> {
    final /* synthetic */ StoresFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StoresFragment$addStoreItemRow$itemRowPickStore$1(StoresFragment storesFragment) {
        super(1);
