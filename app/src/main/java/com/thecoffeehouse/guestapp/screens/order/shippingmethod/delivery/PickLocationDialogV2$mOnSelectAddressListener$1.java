...
public final class PickLocationDialogV2$mOnSelectAddressListener$1 extends Lambda implements Function1<AddressSuggestion, Unit> {
    public static final PickLocationDialogV2$mOnSelectAddressListener$1 INSTANCE = new PickLocationDialogV2$mOnSelectAddressListener$1();

    PickLocationDialogV2$mOnSelectAddressListener$1() {
        super(1);
    }
