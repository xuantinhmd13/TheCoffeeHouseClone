...
public final class SearchStoreInteraction$addFoundStoreRow$itemRowStore$1 extends Lambda implements Function1<Store, Unit> {
    final /* synthetic */ SearchStoreInteraction this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SearchStoreInteraction$addFoundStoreRow$itemRowStore$1(SearchStoreInteraction searchStoreInteraction) {
        super(1);
    ...
    public final void invoke(Store store) {
        ...
        GeneralKt.log("selectedStore: " + store.getId());
