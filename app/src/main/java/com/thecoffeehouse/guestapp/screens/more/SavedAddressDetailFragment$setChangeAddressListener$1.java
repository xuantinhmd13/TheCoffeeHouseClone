...
final class SavedAddressDetailFragment$setChangeAddressListener$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ LinearLayout $this_setChangeAddressListener;
    final /* synthetic */ SavedAddressDetailFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SavedAddressDetailFragment$setChangeAddressListener$1(SavedAddressDetailFragment savedAddressDetailFragment, LinearLayout linearLayout) {
        super(1);
        this.this$0 = savedAddressDetailFragment;
        this.$this_setChangeAddressListener = linearLayout;
    }
    ...
    public final void invoke(View view) {
        ...
        PickLocationDialogV2 newInstance = PickLocationDialogV2.Companion.newInstance(false, new SavedAddressDetailFragment$setChangeAddressListener$1$pickLocationDialogV2$1(this));
