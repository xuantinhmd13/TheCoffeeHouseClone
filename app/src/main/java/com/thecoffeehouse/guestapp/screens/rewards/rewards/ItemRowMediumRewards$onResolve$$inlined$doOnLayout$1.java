...
public final class ItemRowMediumRewards$onResolve$$inlined$doOnLayout$1 implements View.OnLayoutChangeListener {
    final /* synthetic */ ItemRowMediumRewards this$0;

    public ItemRowMediumRewards$onResolve$$inlined$doOnLayout$1(ItemRowMediumRewards itemRowMediumRewards) {
        this.this$0 = itemRowMediumRewards;
    }

    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        Intrinsics.checkParameterIsNotNull(view, ViewHierarchyConstants.VIEW_KEY);
        view.removeOnLayoutChangeListener(this);
        Glide.with(this.this$0.getImgRewards().getContext()).load(ItemRowMediumRewards.access$getReward$p(this.this$0).getImage()).into(this.this$0.getImgRewards());
    }
}
