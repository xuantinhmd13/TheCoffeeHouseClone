...
public final class CheckoutDialogFragment$onOrderLineDelete$1 extends Lambda implements Function2<OrderLine, Integer, Unit> {
    public static final CheckoutDialogFragment$onOrderLineDelete$1 INSTANCE = new CheckoutDialogFragment$onOrderLineDelete$1();

    CheckoutDialogFragment$onOrderLineDelete$1() {
        super(2);
    }
