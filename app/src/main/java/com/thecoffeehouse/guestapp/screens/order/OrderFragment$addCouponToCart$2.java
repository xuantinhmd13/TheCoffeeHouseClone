...
public final class OrderFragment$addCouponToCart$2 extends Lambda implements Function1<ServerErrorResponse, Unit> {
    final /* synthetic */ OrderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    OrderFragment$addCouponToCart$2(OrderFragment orderFragment) {
        super(1);
    ...
    public final void invoke(ServerErrorResponse serverErrorResponse) {
        ...
        this.this$0.getMTrackingEventOrder().triggerSendEventApplyAVoucherFailed();
    }
}
