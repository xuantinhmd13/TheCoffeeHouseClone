...
public final class RecentOrderDialogFragment$orderViewModel$2 extends Lambda implements Function0<OrderViewModel> {
    final /* synthetic */ RecentOrderDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RecentOrderDialogFragment$orderViewModel$2(RecentOrderDialogFragment recentOrderDialogFragment) {
        super(0);
