...
public final class HomeFragment$mObserveOrdersProcessing$1 extends Lambda implements Function1<GetOrdersProcessingResponse, Unit> {
    final /* synthetic */ HomeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HomeFragment$mObserveOrdersProcessing$1(HomeFragment homeFragment) {
        super(1);
    ...
    public final void invoke(GetOrdersProcessingResponse getOrdersProcessingResponse) {
        ...
        this.this$0.triggerSendEventTracking();
    }
}
