...
public final class EditProfileDialogFragment$openBottomSheetAvatar$2 extends Lambda implements Function1<View, Unit> {
    ...
    EditProfileDialogFragment$openBottomSheetAvatar$2(EditProfileDialogFragment editProfileDialogFragment, BottomSheetDialog bottomSheetDialog) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        this.this$0.dispatchPickFileIntent();
