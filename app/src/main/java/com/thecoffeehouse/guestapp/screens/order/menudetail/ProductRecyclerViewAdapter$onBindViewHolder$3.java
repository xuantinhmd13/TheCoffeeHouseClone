...
final class ProductRecyclerViewAdapter$onBindViewHolder$3 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ Product $product;
    final /* synthetic */ ProductRecyclerViewAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProductRecyclerViewAdapter$onBindViewHolder$3(ProductRecyclerViewAdapter productRecyclerViewAdapter, Product product) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        this.this$0.onClickFavouriteListener.invoke(this.$product);
    }
}
