...
public final class RatingOrderDetailDialogFragment$mObserveRatingOrder$1 extends Lambda implements Function1<ServerErrorResponse, Unit> {
    final /* synthetic */ RatingOrderDetailDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RatingOrderDetailDialogFragment$mObserveRatingOrder$1(RatingOrderDetailDialogFragment ratingOrderDetailDialogFragment) {
        super(1);
    ...
    public final void invoke(ServerErrorResponse serverErrorResponse) {
        ...
        this.this$0.mOnDismissListener.invoke();
        this.this$0.dismiss();
    }
}
