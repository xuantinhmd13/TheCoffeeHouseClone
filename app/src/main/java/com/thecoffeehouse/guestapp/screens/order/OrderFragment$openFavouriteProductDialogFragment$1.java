...
public final class OrderFragment$openFavouriteProductDialogFragment$1 extends Lambda implements Function1<Product, Unit> {
    final /* synthetic */ OrderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    OrderFragment$openFavouriteProductDialogFragment$1(OrderFragment orderFragment) {
        super(1);
