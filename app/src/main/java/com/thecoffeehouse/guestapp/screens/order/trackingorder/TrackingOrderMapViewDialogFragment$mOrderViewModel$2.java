...
public final class TrackingOrderMapViewDialogFragment$mOrderViewModel$2 extends Lambda implements Function0<OrderViewModel> {
    final /* synthetic */ TrackingOrderMapViewDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TrackingOrderMapViewDialogFragment$mOrderViewModel$2(TrackingOrderMapViewDialogFragment trackingOrderMapViewDialogFragment) {
        super(0);
