...
public final class LoginActivity$checkProfileStatus$signUpDialog$1 extends Lambda implements Function5<SignUpDialogFragment, String, String, String, Integer, Unit> {
    final /* synthetic */ AuthResponse $resource;
    final /* synthetic */ LoginActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LoginActivity$checkProfileStatus$signUpDialog$1(LoginActivity loginActivity, AuthResponse authResponse) {
        super(5);
    ...
    public final void invoke(SignUpDialogFragment signUpDialogFragment, String str, String str2, String str3, int i) {
        ...
        LoginActivity.access$getViewModel$p(this.this$0).callSignUpToServer(this.$resource.getToken(), this.this$0.mPhoneNumber, this.this$0.mOTP, str, str2, str3, i).observe(this.this$0, new LoginActivity.ObserverBaseResource(this.this$0, new Function1<AuthResponse, Unit>(this) {
            /* class com.thecoffeehouse.guestapp.screens.login.LoginActivity$checkProfileStatus$signUpDialog$1.AnonymousClass1 */
            final /* synthetic */ LoginActivity$checkProfileStatus$signUpDialog$1 this$0;
