...
public final class OrderFragment$fillDeliInfoDefault$1 extends Lambda implements Function1<AddressSuggestion, Unit> {
    final /* synthetic */ Function1 $onCompleted;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    OrderFragment$fillDeliInfoDefault$1(Function1 function1) {
        super(1);
