...
public final class PickLocationDialogV2$fetchUserSavedAddress$1 extends Lambda implements Function1<UserAddressResponse, Unit> {
    final /* synthetic */ PickLocationDialogV2 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PickLocationDialogV2$fetchUserSavedAddress$1(PickLocationDialogV2 pickLocationDialogV2) {
        super(1);
    ...
    public final void invoke(UserAddressResponse userAddressResponse) {
        ...
        this.this$0.mUserAddresses = userAddressResponse;
        ...
        this.this$0.addRowItemRecentAddress(userAddressResponse.getRecentAddresses());
    }
}
