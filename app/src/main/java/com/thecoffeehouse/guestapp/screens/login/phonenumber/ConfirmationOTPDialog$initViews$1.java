...
public final class ConfirmationOTPDialog$initViews$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ ConfirmationOTPDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConfirmationOTPDialog$initViews$1(ConfirmationOTPDialog confirmationOTPDialog) {
        super(1);
