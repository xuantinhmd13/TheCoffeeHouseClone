...
final class RewardsByCategoryDialogFragment$mRewardViewModel$2 extends Lambda implements Function0<RewardsViewModel> {
    final /* synthetic */ RewardsByCategoryDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RewardsByCategoryDialogFragment$mRewardViewModel$2(RewardsByCategoryDialogFragment rewardsByCategoryDialogFragment) {
        super(0);
