...
public final class SelectShippingMethodDialog$initTableButton$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ SelectShippingMethodDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SelectShippingMethodDialog$initTableButton$2(SelectShippingMethodDialog selectShippingMethodDialog) {
        super(1);
