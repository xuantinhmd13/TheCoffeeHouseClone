...
public final class RatingAndFeedbackFragment$mObserveRatingOrder$1 extends Lambda implements Function1<GetOrdersHistoryResponse, Unit> {
    final /* synthetic */ RatingAndFeedbackFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RatingAndFeedbackFragment$mObserveRatingOrder$1(RatingAndFeedbackFragment ratingAndFeedbackFragment) {
        super(1);
    ...
    public final void invoke(GetOrdersHistoryResponse getOrdersHistoryResponse) {
        ...
        this.this$0.initRatingOrders(getOrdersHistoryResponse.getHistories());
    }
}
