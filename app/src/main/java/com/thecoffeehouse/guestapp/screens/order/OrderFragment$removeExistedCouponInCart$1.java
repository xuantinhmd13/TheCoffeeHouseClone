...
public final class OrderFragment$removeExistedCouponInCart$1 extends Lambda implements Function1<CalculateOrderResponse, Unit> {
    final /* synthetic */ OrderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    OrderFragment$removeExistedCouponInCart$1(OrderFragment orderFragment) {
        super(1);
    ...
    public final void invoke(CalculateOrderResponse calculateOrderResponse) {
        ...
        Toast.makeText(this.this$0.requireContext(), this.this$0.getString(R.string.str_removed_this_coupon_for_your_cart), 0).show();
    }
}
