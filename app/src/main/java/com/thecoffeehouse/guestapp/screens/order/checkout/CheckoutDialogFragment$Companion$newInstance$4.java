...
final class CheckoutDialogFragment$Companion$newInstance$4 extends Lambda implements Function1<Payment, Unit> {
    public static final CheckoutDialogFragment$Companion$newInstance$4 INSTANCE = new CheckoutDialogFragment$Companion$newInstance$4();

    CheckoutDialogFragment$Companion$newInstance$4() {
        super(1);
    }
