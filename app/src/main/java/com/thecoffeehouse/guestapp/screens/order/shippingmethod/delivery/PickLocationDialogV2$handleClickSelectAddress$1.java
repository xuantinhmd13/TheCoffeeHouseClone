...
public final class PickLocationDialogV2$handleClickSelectAddress$1 extends Lambda implements Function1<AddressSuggestion, Unit> {
    final /* synthetic */ PickLocationDialogV2 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PickLocationDialogV2$handleClickSelectAddress$1(PickLocationDialogV2 pickLocationDialogV2) {
        super(1);
    ...
    public final void invoke(AddressSuggestion addressSuggestion) {
        ...
        this.this$0.performSelectAddress(addressSuggestion);
    }
}
