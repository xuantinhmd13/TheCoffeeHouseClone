...
public final class HomeFragment$initMediaBox$2 implements View.OnTouchListener {
    final /* synthetic */ HomeFragment this$0;

    HomeFragment$initMediaBox$2(HomeFragment homeFragment) {
    ...
    public final boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        HomeFragment.access$getPeriodicUpdate$p(this.this$0).run();
        return false;
    }
}
