...
public final class VerifyPhoneDialog$initToolbar$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ VerifyPhoneDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VerifyPhoneDialog$initToolbar$1(VerifyPhoneDialog verifyPhoneDialog) {
        super(1);
