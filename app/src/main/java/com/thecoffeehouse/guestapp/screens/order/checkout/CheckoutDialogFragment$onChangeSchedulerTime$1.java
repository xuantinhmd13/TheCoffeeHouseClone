...
public final class CheckoutDialogFragment$onChangeSchedulerTime$1 extends Lambda implements Function1<ScheduleTime, Unit> {
    public static final CheckoutDialogFragment$onChangeSchedulerTime$1 INSTANCE = new CheckoutDialogFragment$onChangeSchedulerTime$1();

    CheckoutDialogFragment$onChangeSchedulerTime$1() {
        super(1);
    }
