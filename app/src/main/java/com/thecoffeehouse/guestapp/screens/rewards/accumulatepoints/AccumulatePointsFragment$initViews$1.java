...
final class AccumulatePointsFragment$initViews$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ AccumulatePointsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AccumulatePointsFragment$initViews$1(AccumulatePointsFragment accumulatePointsFragment) {
        super(0);
