...
final class CartItemRecyclerViewAdapter$ViewHolder$bind$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ Function2 $onItemClickListener;
    final /* synthetic */ OrderLine $orderline;
    final /* synthetic */ int $position;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CartItemRecyclerViewAdapter$ViewHolder$bind$1(Function2 function2, OrderLine orderLine, int i) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        TrackingEventService.Companion.collectParamWithEventName(EditCartEvents.EventCartItemEditedSuccessfully.name, new TrackingData("entryPoints", "Tap On Item"));
