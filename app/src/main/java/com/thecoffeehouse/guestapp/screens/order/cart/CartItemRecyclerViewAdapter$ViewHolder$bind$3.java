...
final class CartItemRecyclerViewAdapter$ViewHolder$bind$3 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ Function2 $onItemDeleteListener;
    final /* synthetic */ OrderLine $orderline;
    final /* synthetic */ int $position;
    final /* synthetic */ CartItemRecyclerViewAdapter.ViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CartItemRecyclerViewAdapter$ViewHolder$bind$3(CartItemRecyclerViewAdapter.ViewHolder viewHolder, Function2 function2, OrderLine orderLine, int i) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        TrackingEventService.Companion.collectParamWithEventName(EditCartEvents.EventCartItemRemovedSuccessfully.name, new TrackingData("entryPoints", "On Swipe"));
        this.$onItemDeleteListener.invoke(this.$orderline, Integer.valueOf(this.$position));
