...
public final class ItemRowSmallRewards$onResolve$$inlined$doOnLayout$1 implements View.OnLayoutChangeListener {
    final /* synthetic */ ItemRowSmallRewards this$0;

    public ItemRowSmallRewards$onResolve$$inlined$doOnLayout$1(ItemRowSmallRewards itemRowSmallRewards) {
    ...
    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        Glide.with(this.this$0.getImgRewards().getContext()).load(ItemRowSmallRewards.access$getReward$p(this.this$0).getImage()).into(this.this$0.getImgRewards());
    }
}
