...
public final class CheckoutDialogFragment$onChangePaymentMethod$1 extends Lambda implements Function1<Payment, Unit> {
    public static final CheckoutDialogFragment$onChangePaymentMethod$1 INSTANCE = new CheckoutDialogFragment$onChangePaymentMethod$1();

    CheckoutDialogFragment$onChangePaymentMethod$1() {
        super(1);
    }
