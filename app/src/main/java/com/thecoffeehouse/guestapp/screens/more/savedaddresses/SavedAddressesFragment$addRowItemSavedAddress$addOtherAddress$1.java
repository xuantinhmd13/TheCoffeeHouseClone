...
public final class SavedAddressesFragment$addRowItemSavedAddress$addOtherAddress$1 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ SavedAddressesFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SavedAddressesFragment$addRowItemSavedAddress$addOtherAddress$1(SavedAddressesFragment savedAddressesFragment) {
        super(1);
    ...
    public final void invoke(int i) {
        GeneralKt.log("run flow other address");
        AddressSuggestion addressSuggestion = new AddressSuggestion();
        addressSuggestion.setType(AddressType.INSTANCE.getOTHER());
