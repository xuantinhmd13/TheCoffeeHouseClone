...
public final class NewsAndPromotionsDialogFragment$openShareReportPopup$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ BottomSheetDialog $shareReportBottomSheetDialog;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NewsAndPromotionsDialogFragment$openShareReportPopup$2(BottomSheetDialog bottomSheetDialog) {
        super(1);
