...
public final class PickLocationDialogV2$showMapPickLocationDialogFragment$observeGetPickLocation$2 extends Lambda implements Function1<ServerErrorResponse, Unit> {
    final /* synthetic */ PickLocationDialogV2 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PickLocationDialogV2$showMapPickLocationDialogFragment$observeGetPickLocation$2(PickLocationDialogV2 pickLocationDialogV2) {
        super(1);
    ...
    public final void invoke(ServerErrorResponse serverErrorResponse) {
        ...
        if (mapPickLocationFragment != null) {
            mapPickLocationFragment.hideLoading();
        }
    }
}
