...
public final class PickLocationDialogV2$showMapPickLocationDialogFragment$2 extends Lambda implements Function1<AddressSuggestion, Unit> {
    final /* synthetic */ PickLocationDialogV2 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PickLocationDialogV2$showMapPickLocationDialogFragment$2(PickLocationDialogV2 pickLocationDialogV2) {
        super(1);
    ...
    public final void invoke(AddressSuggestion addressSuggestion) {
        ...
        PickLocationDialogV2.sendTrackingChangedAddressSuccessfully$default(this.this$0, ShippingMethodEvents.EventDeliAddressChangedSuccessfully.Value.Search_Result, false, false, true, 6, null);
