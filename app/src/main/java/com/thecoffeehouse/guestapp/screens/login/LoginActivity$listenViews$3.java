...
final class LoginActivity$listenViews$3 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ LoginActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LoginActivity$listenViews$3(LoginActivity loginActivity) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        this.this$0.mLoginWithPhone = true;
        this.this$0.loginWithPhoneNumberFlow();
