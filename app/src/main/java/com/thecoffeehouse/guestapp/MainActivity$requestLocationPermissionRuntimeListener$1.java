...
public final class MainActivity$requestLocationPermissionRuntimeListener$1 extends Lambda implements Function2<AddressSuggestion, Boolean, Unit> {
    final /* synthetic */ Function2 $onRequestSuccess;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainActivity$requestLocationPermissionRuntimeListener$1(Function2 function2) {
        super(2);
    ...
    public final void invoke(AddressSuggestion addressSuggestion, Boolean bool) {
        ...
        this.$onRequestSuccess.invoke(true, addressSuggestion);
    }
}
