...
/* compiled from: di.kt */
public final class APIService$$special$$inlined$inject$1 implements ReadOnlyProperty<Object, TCHApplication> {
    final /* synthetic */ String $scope;
    private TCHApplication value;

    public APIService$$special$$inlined$inject$1(String str) {
        this.$scope = str;
    }
