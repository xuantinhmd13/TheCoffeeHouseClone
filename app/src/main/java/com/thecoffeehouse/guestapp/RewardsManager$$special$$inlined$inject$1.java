...
/* compiled from: di.kt */
public final class RewardsManager$$special$$inlined$inject$1 implements ReadOnlyProperty<Object, AppExecutors> {
    final /* synthetic */ String $scope;
    private AppExecutors value;

    public RewardsManager$$special$$inlined$inject$1(String str) {
        this.$scope = str;
    }
