...
public final class TLImageButton extends AppCompatImageButton implements IBackgroundColor, ICornerView, IStrokeView {
    ...
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TLImageButton(Context context, AttributeSet attributeSet, int i) {
    ...
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TLImageButton(Context context, AttributeSet attributeSet) {
    ...
    public static /* synthetic */ void setColors$default(TLImageButton tLImageButton, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = 0;
        }
        tLImageButton.setColors(i, i2);
    }
    ...
    public static /* synthetic */ void setBorderStrokeColor$default(TLImageButton tLImageButton, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = 0;
        }
        tLImageButton.setBorderStrokeColor(i, i2);
    }
    ...
    public static /* synthetic */ void setBackgroundColor$default(TLImageButton tLImageButton, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = 0;
        }
        tLImageButton.setBackgroundColor(i, i2);
    }
    ...
    public static /* synthetic */ void setBorderStrokeColor$default(TLImageButton tLImageButton, int i, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i2 = 0;
        }
        tLImageButton.setBorderStrokeColor(i, i2, i3);
    }
