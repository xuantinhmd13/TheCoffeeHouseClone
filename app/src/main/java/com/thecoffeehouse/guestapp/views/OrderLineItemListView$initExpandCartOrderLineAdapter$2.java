...
public final class OrderLineItemListView$initExpandCartOrderLineAdapter$2 extends Lambda implements Function2<OrderLine, Integer, Unit> {
    final /* synthetic */ OrderLineItemListView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    OrderLineItemListView$initExpandCartOrderLineAdapter$2(OrderLineItemListView orderLineItemListView) {
        super(2);
