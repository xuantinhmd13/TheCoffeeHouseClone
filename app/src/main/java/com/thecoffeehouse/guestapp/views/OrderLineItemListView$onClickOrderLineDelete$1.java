...
final class OrderLineItemListView$onClickOrderLineDelete$1 extends Lambda implements Function2<OrderLine, Integer, Unit> {
    public static final OrderLineItemListView$onClickOrderLineDelete$1 INSTANCE = new OrderLineItemListView$onClickOrderLineDelete$1();

    OrderLineItemListView$onClickOrderLineDelete$1() {
        super(2);
    }
