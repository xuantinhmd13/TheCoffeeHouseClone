...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "", "it", "Lcom/thecoffeehouse/guestapp/services/api/model/common/map/AddressSuggestionResponse;", "invoke"}, k = 3, mv = {1, 4, 0})
/* compiled from: MainActivity.kt */
public final class MainActivity$getAddressSuggestion$1 extends Lambda implements Function1<AddressSuggestionResponse, Unit> {
    final /* synthetic */ Function1 $onCompleted;
    final /* synthetic */ MainActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainActivity$getAddressSuggestion$1(MainActivity mainActivity, Function1 function1) {
        super(1);
    ...
    public final void invoke(AddressSuggestionResponse addressSuggestionResponse) {
        Intrinsics.checkNotNullParameter(addressSuggestionResponse, "it");
        if (addressSuggestionResponse.getAddress() != null) {
            this.this$0.addressSuggestion = addressSuggestionResponse.getAddress();
            this.$onCompleted.invoke(addressSuggestionResponse.getAddress());
            return;
        }
        this.this$0.getDefaultLocation(new Function1<AddressSuggestion, Unit>(this) {
            /* class com.thecoffeehouse.guestapp.MainActivity$getAddressSuggestion$1.AnonymousClass1 */
            final /* synthetic */ MainActivity$getAddressSuggestion$1 this$0;
